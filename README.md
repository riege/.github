...
The folder [.github/ISSUE_TEMPLATE](.github/ISSUE_TEMPLATE) contains issue templates that can be used in any of the Riege repositories.

**Usage of the templates is voluntary.** After applying a template, issue authors and editors may still change and adapt the issue description as they see fit, whether adhering to the original template or not.

The purpose of the templates is to help structure issues both for the authors and editors as for the readers in a predictable, recognisable way that is meaningful with respect to the nature of the issue.
